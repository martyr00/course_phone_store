...
class UserProfile(models.Model):
    ...
    #     with connection.cursor() as cursor:
    #         query_userprofile_instance = """
    #         SELECT
    #             base_userprofile.image,
    #             base_userprofile.number_telephone,
    #             base_userprofile.birth_date,
    #             base_userprofile.address_id
    #        FROM base_userprofile
    #        WHERE id = %s"""
    #         cursor.execute(query_userprofile_instance, [user_id])
    #
    #         instance_userprofile = dictfetchall(cursor)
    #
    #         query_auth_user_instance = """
    #         SELECT
    #             auth_user.password,
    #             auth_user.username,
    ...
    #         WHERE id = %s
    #         """
    #         cursor.execute(query_auth_user_instance, [user_id])
    #         instance_auth_user = dictfetchall(cursor)
    #
    #     if not instance_userprofile or not instance_auth_user:
    ...
    #                    number_telephone = COALESCE(%s, number_telephone),
    ...
    #         cursor.execute(
    #             query_userprofile, [
    #                 data.get('image', instance_userprofile['image']),
    #                 data.get('number_telephone', instance_userprofile['number_telephone']),
    #                 data.get('birth_date', instance_userprofile['birth_date']),
    #                 data.get('address_id', instance_userprofile['address_id']),
    #                 user_id
    #             ]
    #         )
    #
    ...
    #                WHERE id = %s;
    #            """
    #         data_password = make_password(data['password']) if data.get('password') else instance_auth_user['password']
    #         cursor.execute(
    #             query_auth_user, [
    #                 data_password,
    #                 data.get('username', instance_auth_user['username']),
    #                 data.get('first_name', instance_auth_user['first_name']),
    #                 data.get('last_name', instance_auth_user['last_name']),
    #                 data.get('email', instance_auth_user['email']),
    #                 user_id
    #             ]
    #         )
    #
    #     return UserProfile.get_item(user_id)
